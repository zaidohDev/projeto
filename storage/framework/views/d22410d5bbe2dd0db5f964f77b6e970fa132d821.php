...
<html lang="en-us">
        <head>
                <meta charset="utf-8">
                <title>Delight - Material Design Admin Template - Live Preview - WrapBootstrap</title>
                <meta name="description" content="Live preview for Delight - Material Design Admin Template at WrapBootstrap">
        ...
        <body>
                <div id="main">
                        <div id="tray" class="topbar" sty1le="width: auto;">
                            ...
                            <iframe id="preview" src="https://agileui.com/demo/delight/demo/admin-template/index.html" frameborder="0" width="100%"></iframe>
                </div>
                <script>
